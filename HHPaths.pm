...
our $execdir = "/usr/local/psipred/bin";         # path to PSIPRED V2 binaries
our $datadir = "/usr/local/psipred/data";        # path to PSIPRED V2 data files
our $ncbidir = "/usr/local/ncbi/bin";           # path to NCBI binaries (for PSIPRED in addss.pl)
